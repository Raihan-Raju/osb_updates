    ...
    <div class="container-fluid fixed-top">
        <div class="container topbar bg-primary d-none d-lg-block">
            <div class="d-flex justify-content-between">
                <div class="top-info ps-2">
                    ...
                    <small class="me-3"><i class="fa-solid fa-phone-volume me-2 text-secondary"></i><a href="#" class="text-white">+8801314070106
                    </a></small>
                </div>
        ...
        <div class="container px-0">
            <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    ...
                    <a href="index.php?page=home" class="navbar-brand" ><img src="assets/userAssets/img/removebg-osb.png" style="height: max-content; width: 100px;"><span class="text-primary ">Online Shohoj Bazar</span></a>
                ...
                <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                    <div class="navbar-nav mx-auto">
                        ...
                        <a href="index.php?page=shopDetail" class="nav-item nav-link">Shop Detail</a>
                        <!-- <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0 bg-secondary rounded-0">
                                ...
                                <a href="index.php?page=shopDetail" class="dropdown-item">Testimonial</a>
