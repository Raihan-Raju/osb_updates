<!-- ============<div>this still in card with price ========= -->
        <div class="input-group quantity mb-2" style="width: 100px;">
            ...
            <input style="background-color: white" type="text" class="form-control form-control-sm text-center border-0 quantityInput" value="1" readonly>
            <div class="input-group-btn">
